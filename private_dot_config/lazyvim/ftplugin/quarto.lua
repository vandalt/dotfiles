-- Copied from: https://github.com/jmbuhr/quarto-nvim-kickstarter/blob/main/ftplugin/quarto.lua
-- This enables treesitter highlight and motions in code blocks for QMD
-- It's basically the same as md files
